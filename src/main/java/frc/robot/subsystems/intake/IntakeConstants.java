...
public class IntakeConstants {
    ...
    // Activate intake substates
    public final static StateName OPEN_INTAKE_STATE_NAME = new StateName("DEPLOY_INTAKE");
    public final static StateName START_INTAKE_ROLLER_STATE_NAME = new StateName("START_INTAKE_ROLLER");

    // Deactivate intake substates
